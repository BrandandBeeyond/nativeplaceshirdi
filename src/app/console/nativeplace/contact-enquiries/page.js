...
export const metadata = { title: "Contact Enquiries | The Native Place", description: "Track contact form enquiries." };

const summaryCards = [
  { label: "Total Enquiries", value: "0", note: "Connected records will appear here", icon: Mail },
  { label: "New Today", value: "0", note: "Awaiting first submission", icon: MessageSquareText },
  { label: "Phone Calls", value: "0", note: "Missed call follow-ups", icon: PhoneCall },
  { label: "Resolved", value: "0", note: "Closed conversations", icon: Sparkles },
];
...
export default async function ContactEnquiriesPage() {
  ...
  return (
    <ConsoleShell pageTitle="Contact Enquiries" pageDescription="Monitor messages sent from the public contact form and keep replies organized.">
