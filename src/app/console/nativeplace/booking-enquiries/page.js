...
export const metadata = { title: "Booking Enquiries | The Native Place", description: "Track room and stay booking enquiries." };

const summaryCards = [
  { label: "Total Requests", value: "0", note: "Live booking data will appear here", icon: Ticket },
  { label: "Today", value: "0", note: "New booking forms received", icon: CalendarDays },
  { label: "Pending Reply", value: "0", note: "Awaiting confirmation", icon: Clock3 },
  { label: "Confirmed", value: "0", note: "Moved to reservation stage", icon: Sparkles },
];
...
export default async function BookingEnquiriesPage() {
  ...
  return (
    <ConsoleShell pageTitle="Booking Enquiries" pageDescription="Manage reservation requests and keep every stay inquiry in one place.">
