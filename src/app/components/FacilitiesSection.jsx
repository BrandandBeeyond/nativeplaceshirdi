...
function FacilityCard({ facility, index }) {
  return (
    <article className="group h-full overflow-hidden rounded-[28px] bg-[#f6f0e4] shadow-[0_18px_45px_rgba(18,14,10,0.18)]">
      <div className="relative aspect-[4/3] w-full">
        ...
        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/85 via-black/58 to-transparent p-5 pt-16 sm:p-6 sm:pt-20">
          <div className="max-w-[92%] text-white">
            <h3 className="font-heading text-[1.45rem] leading-tight text-white sm:text-[1.7rem]">
              {facility.title}
            </h3>
            <p className="mt-2 text-sm leading-6 text-white/84 sm:text-[15px]">
...
export default function FacilitiesSection() {
  ...
  return (
    <section
      className="relative overflow-hidden bg-[#2a1e18] py-16 sm:py-20 lg:py-24"
      data-aos="fade-up"
    >
      ...
      <div className="relative mx-auto max-w-[1500px] px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center" data-aos="fade-up">
          <span className="font-subheading text-[12px] font-semibold uppercase tracking-[0.42em] text-[#d7e6b5] sm:text-sm">
          ...
          <h2 className="mt-4 font-heading text-4xl leading-[1.08] text-[#f5f1e4] sm:text-5xl lg:text-[4.15rem]">
            Everything You Need, All in One Place
          </h2>

          <p className="mx-auto mt-5 max-w-3xl font-body text-[15px] leading-7 text-white/78 sm:text-lg">
